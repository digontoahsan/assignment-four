...
<template>
    ...
    <div class="container mt-5 pt-4">
        <h1 class="mb-5 fw-bold text-dark" style="font-size: 2.25rem;">My Private Posts</h1>
        <div class="row">
            <div
                class="col-md-4 mb-4"
            ...
            >
                <div class="card h-100 shadow border-0 transition-hover">
                    ...
                    <!-- Image or fallback -->
                    <Link :href="`/private-posts/${post.id}?from=private`" preserve-state>
                        <img
                            v-if="post.image"
                            :src="`/${post.image}`"
                            class="card-img-top"
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        <h5 class="card-title mb-2">
                            <Link
                                :href="`/private-posts/${post.id}?from=private`"
            ...
            >
                <p class="text-muted fs-4">No private posts available.</p>
            </div>
        </div>
